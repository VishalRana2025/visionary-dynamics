...
const IndividualTaxationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Benefits Section */}
<section className="py-20 relative overflow-hidden bg-blue-50">
  {/* Moving Background Objects */}
  <div className="absolute inset-0 overflow-hidden">
    {/* Floating circles */}
    <div className="absolute top-20 left-10 w-64 h-64 bg-blue-200 rounded-full mix-blend-multiply opacity-30 animate-float"></div>
    <div className="absolute bottom-20 right-10 w-80 h-80 bg-cyan-200 rounded-full mix-blend-multiply opacity-30 animate-float animation-delay-2000"></div>
    <div className="absolute top-40 right-40 w-48 h-48 bg-indigo-200 rounded-full mix-blend-multiply opacity-30 animate-float animation-delay-4000"></div>
    
    {/* Small moving dots */}
    <div className="absolute top-32 left-1/4 w-3 h-3 bg-blue-400 rounded-full opacity-40 animate-bounce-slow"></div>
    <div className="absolute bottom-40 right-1/3 w-4 h-4 bg-cyan-400 rounded-full opacity-40 animate-bounce-slow animation-delay-1000"></div>
    <div className="absolute top-2/3 left-1/2 w-2 h-2 bg-indigo-400 rounded-full opacity-40 animate-bounce-slow animation-delay-2000"></div>
    
    {/* Moving lines */}
    <div className="absolute top-60 left-0 w-40 h-1 bg-gradient-to-r from-blue-400 to-transparent rounded-full opacity-30 animate-slide"></div>
    ...
    <div className="absolute top-1/3 right-20">
      <div className="w-12 h-12 border-2 border-blue-300 rounded-lg opacity-20 animate-spin-slow"></div>
    </div>
    <div className="absolute bottom-1/3 left-20">
      <div className="w-16 h-16 border-2 border-cyan-300 rounded-full opacity-20 animate-spin-slow animation-delay-1500"></div>
    </div>
  </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      {benefits.map((benefit, index) => {
        ...
        const bgGradients = [
          ...
          "bg-gradient-to-br from-indigo-100 to-blue-100 border-indigo-200",
        ...
        return (
          <div 
            key={index} 
            className={`group relative bg-gradient-to-br ${bgGradient} backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 overflow-hidden`}
          >
            {/* Decorative background pattern */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/50 rounded-full blur-2xl"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/50 rounded-full blur-2xl"></div>
            ...
            <div className={`relative w-16 h-16 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center mb-6 text-white shadow-xl transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
              {benefit.icon}
              <div className="absolute inset-0 bg-white/30 rounded-2xl opacity-0 group-hover:opacity-100 transition"></div>
            </div>
    ...
    <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 text-center shadow-lg border border-blue-200">
        <div className="text-3xl font-black text-blue-600">50K+</div>
        <div className="text-sm text-gray-600 mt-1">Happy Clients</div>
      </div>
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 text-center shadow-lg border border-cyan-200">
        <div className="text-3xl font-black text-cyan-600">$2.3B</div>
        <div className="text-sm text-gray-600 mt-1">Refunds Secured</div>
      </div>
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 text-center shadow-lg border border-indigo-200">
...
<section className="relative py-20 overflow-hidden">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
    ...
    <div className="text-center mb-12">
      <span className="inline-block px-4 py-2 bg-white/10 backdrop-blur-md text-blue-300 rounded-full text-sm font-semibold mb-4">
        Get Organized
      </span>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {documents.map((section, idx) => (
        <div key={idx} className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
          <h3 className="text-xl font-bold mb-6 text-white">{section.category}</h3>
      ...
      {/* Documents Checklist - Colorful Rainbow Style */}
<section className="py-20 relative overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to-blue-50">
  {/* Floating colorful shapes */}
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute top-20 left-10 w-32 h-32 bg-purple-300 rounded-full opacity-20 animate-float"></div>
    <div className="absolute top-40 right-20 w-40 h-40 bg-pink-300 rounded-full opacity-20 animate-float animation-delay-1000"></div>
    <div className="absolute bottom-20 left-1/3 w-36 h-36 bg-yellow-300 rounded-full opacity-20 animate-float animation-delay-2000"></div>
    <div className="absolute bottom-40 right-1/4 w-28 h-28 bg-green-300 rounded-full opacity-20 animate-float animation-delay-3000"></div>
    <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-blue-300 rounded-full opacity-20 animate-float animation-delay-4000"></div>
  </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {documents.map((section, idx) => {
        // Different vibrant color themes for each card
        const themes = [
          {
        ...
        return (
          <div 
            key={idx} 
            className={`group ${theme.lightBg} rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 ${theme.border} relative overflow-hidden`}
          >
            {/* Colorful top bar */}
            ...
            <div className="relative flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <span className={`inline-block mt-1 text-xs font-bold px-3 py-1 rounded-full ${theme.badge}`}>
                  {section.items.length} colorful items
                </span>
              </div>
            </div>

            {/* Colorful checklist items */}
              ...
              {section.items.map((item, i) => {
                ...
                return (
                  <li key={i} className="flex items-start gap-3 group/item">
                    ...
                    <span className="text-xs text-gray-400 opacity-0 group-hover/item:opacity-100 transition">✓</span>
                  </li>
                );
              })}
            </ul>
            ...
            <div className="relative pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="text-gray-500">Rainbow progress</span>
